...
constexpr auto TEST_DIR_CONFIG_PATH = "/home/pi/projects/AugmentedAI/utils/test_dir_config_rpi.txt";
#else
constexpr auto TEST_DIR_CONFIG_PATH = "C:/D_Data/repos/AugmentedAI/utils/test_dir_config_win.txt";
#endif
